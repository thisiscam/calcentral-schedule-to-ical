...
def calnet_login(username, password):
    ...
    s = requests.Session()
    login_response = s.post('https://auth.berkeley.edu/cas/login?service=https%3A%2F%2Fcalcentral.berkeley.edu%2Fauth%2Fcas%2Fcallback%3Furl%3Dhttps%253A%252F%252Fcalcentral.berkeley.edu%252F', headers=headers, data=data)
